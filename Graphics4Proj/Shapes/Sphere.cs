...
//    {
//        public Sphere(int recursionLevel, Color color)
//        {
...
//        public Triangle[] Create(int recursionLevel)
//        {
...
//                    faces2.Add(new Triangle(tri.V1, points[a], points[c]));
//                    faces2.Add(new Triangle(tri.V2, points[b], points[a]));
//                    faces2.Add(new Triangle(tri.V3, points[c], points[b]));
//                    faces2.Add(new Triangle(points[a], points[b], points[c]));
//                }
