...
namespace Graphics4Proj.Lights
{
    public static class Shading
    {
        ...
        public static ColorRGB Scale_From_0_255_To_0_1(Color color)
        {
            return new ColorRGB { R = color.R / 255.0, G = color.G / 255.0, B = color.B / 255.0 };
        }

        public static Color ScaleFrom_0_1_To_0_255(ColorRGB color)
        {
